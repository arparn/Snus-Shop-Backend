...
class ItemControllerTest {
    ...
    @Test
    void test_min_max_strength(){
        ResponseEntity<List<Item>> exchange = testRestTemplate.exchange("/items/strengthMin", HttpMethod.GET, null, LIST_OF_ITEMS);
        List<Item> items = exchange.getBody();
        Item item = items.get(0);
    ...
    void rating_most_popular(){
        ...
        item6.addGrade(4);
        item6.addGrade(5);
        exchange = testRestTemplate.exchange("/items/ratingMax", HttpMethod.GET, null, LIST_OF_ITEMS);
